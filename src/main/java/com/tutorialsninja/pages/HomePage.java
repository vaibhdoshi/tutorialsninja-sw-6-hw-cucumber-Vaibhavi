...
public class HomePage extends Utility {
    private static final Logger log = LogManager.getLogger(HomePage.class.toString());
    ...
    public void mouseHoverOnDesktopsLinkAndClick() {
        log.info("mousehover on desktops link and click" + desktop.toString());
        mouseHoverToElementAndClick(desktop);
    }

    public void mouseHoverOnLaptopsAndNotebooksLinkAndClick() {
        log.info("mousehover on laptops and notebooks link and click" + lapTopsAndNotebook.toString());
        mouseHoverToElementAndClick(lapTopsAndNotebook);
    }

    public void mouseHoverOnComponentLinkAndClick() {
        log.info("mousehover on components link and click" + components.toString());
